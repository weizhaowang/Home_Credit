...
def main(debug=2000):
    ...
    cols_amt = ['TARGET', 'AMT_INCOME_TOTAL', 'AMT_CREDIT', 'AMT_ANNUITY', 'AMT_GOODS_PRICE']
    ...
    kde_plot(app_train, features, 'amt_4_pic/4_amt_persent_fillna_scaler_kde.png')
    skew_plot(app_train, features, 'amt_4_pic/4_amt_persent_fillna_scaler_skew.png')
    ...
    sub_preds.to_csv('lgb_4amt_persent_-fillmedian-minmax-val-180628.csv', index=False)
    ...
    display_importances(feature_importance, num_features=4, filename='feature_importance.png')
