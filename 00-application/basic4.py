...
def main(debug=2000):
    ...
    aim_cols = ['TARGET', 'EXT_SOURCE_1', 'EXT_SOURCE_2', 'EXT_SOURCE_3', 'DAYS_BIRTH']

    app_train = app_train.loc[:, aim_cols]
    app_test = app_test.loc[:, aim_cols]
    ...
    kde_plot(app_train, features, 'basic_4_pic/4_orgin_kde.png')
    skew_plot(app_train, features, 'basic_4_pic/4_origin_skew.png')
    ...
    kde_plot(app_train, features, 'basic_4_pic/4_fillna_scaler_kde.png')
    skew_plot(app_train, features, 'basic_4_pic/4_fillna_scaler_skew.png')
    ...
    sub_preds.to_csv('lgb_4basic-fillmedian-minmax-val-180628.csv', index=False)
    ...
    kde_plot(app_train, features, 'basic_4_pic/4_boxcox_kde.png')
    skew_plot(app_train, features, 'basic_4_pic/4_boxcox_skew.png')
    ...
    sub_preds.to_csv('lgb_4basic-boxcox-val-180628.csv', index=False)
